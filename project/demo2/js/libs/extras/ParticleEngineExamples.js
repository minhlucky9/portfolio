...
/* 
	...
	particleTexture : new THREE.TextureLoader().load( 'textures/star.png' ),
...
Examples =
{
	...
	fireball :
	{
		...
		particleTexture : new THREE.TextureLoader().load( 'textures/smokeparticle.png' ),
	...
	snow :
	{
		...
		particleTexture : new THREE.TextureLoader().load( 'textures/snowflake.png' ),
	...
	rain :
	{
		...
		particleTexture : new THREE.TextureLoader().load( 'textures/raindrop2flip.png' ),
	...
	starfield :
	{
		...
		particleTexture : new THREE.TextureLoader().load( 'textures/spikey.png' ),
	...
	fireflies :
	{
		positionStyle  : Type.CUBE,
		positionBase   : new THREE.Vector3( 0, 5, 0 ),
		positionSpread : new THREE.Vector3( 80, 100, 80 ),

		velocityStyle  : Type.CUBE,
		velocityBase   : new THREE.Vector3( 0, 0, 0 ),
		velocitySpread : new THREE.Vector3( 10, 7, 10 ), 
		
		particleTexture : new THREE.TextureLoader().load( 'textures/spark.png' ),
	...
	{
		positionStyle  : Type.CUBE,
		positionBase   : new THREE.Vector3( 9.8, 6.9, 8.4 ),
	...
	{
		positionStyle  : Type.SPHERE,
		positionBase   : new THREE.Vector3( -8.3, 2.6, 14.3 ),
		positionRadius : 0.04,
		
		velocityStyle  : Type.CUBE,
		velocityBase   : new THREE.Vector3(0,1,0),
		velocitySpread : new THREE.Vector3(1.2,0,1.2),
		
		particleTexture : new THREE.TextureLoader().load( 'textures/smokeparticle.png' ),
		
		sizeTween    : new Tween( [0, 0.5, 1.2], [2.0, 0.7, 0.01] ),
		opacityTween : new Tween( [0, 0.9, 1.5], [1, 0.7, 0] ),
		colorTween   : new Tween( [0.5, 1.0], [ new THREE.Vector3(0.02, 1, 0.5), new THREE.Vector3(0.05, 1, 0) ] ),
		blendStyle : THREE.AdditiveBlending,  
	...
	{
		positionStyle  : Type.SPHERE,
		positionBase   : new THREE.Vector3( -11, 1, -12 ),
		positionRadius : 0.04,
